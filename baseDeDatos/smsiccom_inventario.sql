...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-06-2023 a las 22:51:40
...
INSERT INTO `nota_entrega` (`id_ne`, `fk_id_prof_ne`, `orden_ne`, `observacion_ne`) VALUES
(41, 319, 4563165161, '');
...
--
ALTER TABLE `categoria`
  MODIFY `id_ctgr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `cliente`
--
ALTER TABLE `cliente`
  MODIFY `id_clte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `empresa`
  MODIFY `id_emp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
...
--
ALTER TABLE `inventario`
  MODIFY `id_inv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `mdf_proforma`
  MODIFY `id_mprof` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `mdf_prof_prod`
--
ALTER TABLE `mdf_prof_prod`
  MODIFY `id_mpfpd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `nota_entrega`
--
ALTER TABLE `nota_entrega`
  MODIFY `id_ne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `id_prod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;

--
-- AUTO_INCREMENT de la tabla `proforma`
--
ALTER TABLE `proforma`
  MODIFY `id_prof` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=320;

--
-- AUTO_INCREMENT de la tabla `prof_prod`
--
ALTER TABLE `prof_prod`
  MODIFY `id_pfpd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `venta`
  MODIFY `id_vnt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `vnt_prod`
--
ALTER TABLE `vnt_prod`
  MODIFY `id_vtpd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
