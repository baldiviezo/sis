...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2023 a las 23:00:23
...
(47, 333, 4563165161, '', 'pendiente'),
(48, 334, 4563165161, '', 'vendido'),
(49, 335, 195646546565, '', 'vendido');
...
(50, '2023-06-20 04:00:00', '9498498', 335, 64, '');
...
--
ALTER TABLE `nota_entrega`
  MODIFY `id_ne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `prof_prod`
  MODIFY `id_pfpd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `venta`
  MODIFY `id_vnt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT de la tabla `vnt_prod`
--
ALTER TABLE `vnt_prod`
  MODIFY `id_vtpd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
