         ...
         if(trim($xaux) != "")
         {
            switch ($xz)
            {
               ...
               case 2:
                  if($xcifra < 1)
                  {
                     $xcadena = "CERO ".strtoupper($moneda)." $xdecimales/100 BOLIVIANOS" .strtoupper($centimos);  // borrar en caso no se desee decimales /100
                  }
                  if($xcifra >= 1 && $xcifra < 2)
                  {
                     $xcadena = "UNO ".strtoupper($moneda)." $xdecimales/100 BOLIVIANOS".strtoupper($centimos);   // borrar en caso no se desee decimales /100
                  }
                  if($xcifra >= 2)
                  {
                     $xcadena .= strtoupper($moneda)." $xdecimales/100 BOLIVIANOS".strtoupper($centimos);  // borrar en caso no se desee decimales /100
                  }
                  break;
            } // endswitch ($xz)
         } // ENDIF (trim($xaux) != "")
